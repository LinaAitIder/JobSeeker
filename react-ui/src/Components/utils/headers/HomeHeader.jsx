...
const HomeHeader = () => {
  return (
    <header className="p-4 bg-blue-500 top-0 sticky w-full z-50">
      <div className="flex flex-row items-center justify-between">
       ...
       <div className="ml-2 ">
        ...
        <MenuItems anchor="bottom end" className="z-50 bg-white rounded-md shadow-lg p-1 ring-1 ring-black/5 focus:outline-none mt-1">
